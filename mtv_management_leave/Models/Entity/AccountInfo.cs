...
{
    public class AccountInfo : IdentityUser<int, UserLogin, UserRole, UserClaim>, Interface.IEntity
    {
        ...
        public async Task<ClaimsIdentity> GenerateUserIdentityAsync(UserManager<AccountInfo, int> manager)
        {
